...
- [EVM JIT spec (archived)](../../specs/_archive/2026-02/add-jit-suitability-checker/specs/evm-jit/spec.md): EVM JIT requirements (Multipass-only, suitability analysis, RA-expensive classification)
